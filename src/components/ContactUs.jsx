            ...
            <form className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full' >
                <div>
                    ...
                    <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                        ...
                        <input type="text" required placeholder='Enter your name' className='w-full p-3 text-sm outline-none' />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                        ...
                        <input type="email" required placeholder='Enter your email' className='w-full p-3 text-sm outline-none' />
                    </div>
                </div>
